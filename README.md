...
This is [DedMarchy](https://github.com/VaheOfficial/DedMarchy), a Watch Dogs-styled layer on top of Omarchy 4: the DedSec theme, a Quickshell login screen, a typewriter boot splash, an eww desktop HUD, BlackArch tooling, and VM support for VMware, VirtualBox, and Hyper-V. See [DEDSEC.md](DEDSEC.md). Install Omarchy 4 from the ISO, then run:
